...
ax[0, 0].plot( y_train[:, 0], predictions[:, 0], 'kx', alpha = 0.05,
               label = 'rescaled vel-dispersion')
ax[0, 1].plot( y_train[:, 1], predictions[:, 1], 'kx', alpha = 0.05,
               label = 'rescaled ellipticity')
ax[0, 2].plot( y_train[:, 2], predictions[:, 2], 'kx', alpha = 0.05,
               label = 'rescaled orientation')
ax[1, 0].plot( y_train[:, 3], predictions[:, 3], 'kx', alpha = 0.05,
               label = 'rescaled redshift')
ax[1, 1].plot( y_train[:, 4], predictions[:, 4], 'kx', alpha = 0.05,
