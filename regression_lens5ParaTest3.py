...
#Code to test the model that predicts 3 lensing parameters (ellipticity, orientation, and velocity dispersion)
...
#for i in range(len(filelist)):
    # fileIn = filelist[i]
fileIn = '/users/jbbutler129/Desktop/Argonne_Files/Galaxy_Lens_Regression/Model_Runs/RegressionStackNew_opti1_loss0_lr0.001_decay0.1_batch16_epoch10.hdf5'

    #
    # histIn = histlist[i]
histIn = '/users/jbbutler129/Desktop/Argonne_Files/Galaxy_Lens_Regression/Model_Runs/RegressionStackNew_opti1_loss0_lr0.001_decay0.1_batch16_epoch10.npy'
